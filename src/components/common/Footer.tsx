          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">123 Medical Center Drive, New York, NY 10001</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">info@prescripto.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Clock size={16} className="text-blue-400" />
                <span className="text-gray-400 text-sm">Mon-Fri: 8AM-8PM<br />Sat-Sun: 9AM-6PM</span>
              </div>
            </div>
          </div>
        </div>
